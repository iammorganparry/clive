...
This is a REQUIRED checklist for planning mode. You MUST complete all steps and document findings.
...
**1. FIND SIMILAR TEST FILES** (MANDATORY):
   ...
   - **Document**: List paths of 2-3 similar test files
...
**3. DISCOVER ALL MOCK FACTORIES** (MANDATORY):
   ...
   - **Map**: For each dependency, check if mock factory exists
