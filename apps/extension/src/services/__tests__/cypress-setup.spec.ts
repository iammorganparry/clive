...
describe("cypress-setup", () => {
  ...
  describe("getInitCommand", () => {
    it("should return correct command for yarn", () => {
      ...
      expect(command).toBe(
        "yarn add cypress -D && npx cypress open --e2e --browser electron",
      );
    });
    ...
    it("should return correct command for pnpm", () => {
      ...
      expect(command).toBe(
        "pnpm add -D cypress && npx cypress open --e2e --browser electron",
      );
    });
    ...
    it("should return correct command for npm", () => {
      ...
      expect(command).toBe(
        "npm install cypress --save-dev && npx cypress open --e2e --browser electron",
      );
    });
