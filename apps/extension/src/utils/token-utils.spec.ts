...
Line 3`;
  ...
  describe('calculateTruncationLines', () => {
    ...
    it('should scale with token budget', () => {
      ...
      expect(largeBudget.keepFromStart).toBeGreaterThan(smallBudget.keepFromStart);
  ...
  describe('batchFiles', () => {
    ...
    it('should not exceed token limit per batch', () => {
      ...
      for (const batch of batches) {
        ...
        expect(batchTokens).toBeLessThanOrEqual(maxBatchTokens + estimateFileTokens('dummy.ts'));
      }
    });
