...
describe('ThemeService', () => {
	...
	describe('initializeTheme', () => {
		...
		it('should map VS Code CSS variables to shadcn variables', () => {
			...
			expect(document.documentElement.style.getPropertyValue('--input')).toBe('#3c3c3c');
			expect(document.documentElement.style.getPropertyValue('--border')).toBe('#454545');
			expect(
			...
			expect(document.documentElement.style.getPropertyValue('--muted')).toBe('#252526');
		...
		it('should use panel-border as fallback when input-border is not available', () => {
			...
			expect(document.documentElement.style.getPropertyValue('--border')).toBe('#454545');
			expect(document.documentElement.style.getPropertyValue('--ring')).toBe('#454545');
